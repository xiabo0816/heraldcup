...
- 全部 / 先锋杯 / 传奇杯 / 冠绝杯的页面级范围条继续只属于第一期对象频道；第二期页面不复用这套紧贴顶部导航的简单二级导航条与条件性 Banner 结构
...
- 需要继续落页面布局、区块规格、状态流和组件模式时，优先读 15_phase-two-blueprints-and-specs.md，再回到 10_page-blueprint.md、11_section-specs.md、12_wireflow-and-state-spec.md、13_component-variant-matrix.md 套用全站通用规格
