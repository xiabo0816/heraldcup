...
- 页面级范围条就是双轴矩阵纵轴在页面上的二级导航展开，因此它不能被简化成普通筛选条；当前范围的标题、统计和右栏说明在导航条之外的正文或侧栏中同步体现
- 比赛、选手、战队频道页的首屏固定顺序是顶部导航 -> 二级导航（页面级范围条） -> 条件性范围 Banner（仅具体杯赛态） -> 主体
- 条件性范围 Banner 只允许位于二级导航下方；“全部”态不显示 Banner
...
- 第二层以下的条件性 Banner：仅存在于 /matches、/players、/teams 的具体杯赛态，负责承接当前范围摘要，且必须位于二级导航下方
