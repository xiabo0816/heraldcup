...
### 7.1 Conditional Scope Banner（选手变体）

| 字段 | 内容 |
| --- | --- |
| 区块名称 | Conditional Scope Banner（选手变体） |
...
- Range Stage Band 要与下方 Banner 或正文首块共同组成一个连续首屏系统；它不能只在顶部自成一条孤立横条
...
- 频道页首屏层级固定为顶部导航 -> Conditional Scope Banner（仅某杯态，可选） -> 二级导航（页面级范围条） -> 主工作台或主目录
