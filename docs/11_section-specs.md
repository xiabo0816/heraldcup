...
- 补充：若 PageIntro 被复用于 /matches、/players、/teams 的唯一 Banner 内部版式，或用于二级导航之后直接承接的正文首块标题区，且当前范围为具体杯赛态，则其背景、描边、强调标题和 CTA 必须挂接当前主题壳层；它不得在二级导航与 Banner、或二级导航与正文之间再单独起一层题头
